...
func BufferData(target uint32, size int, data unsafe.Pointer, usage uint32) {
	...
	cdata, _ := (C.GLvoid)(unsafe.Pointer(data)), cgoAllocsUnknown
...
func ColorPointer(size int32, kind uint32, stride int32, pointer unsafe.Pointer) {
	...
	cpointer, _ := (C.GLvoid)(unsafe.Pointer(pointer)), cgoAllocsUnknown
...
func DrawElements(mode uint32, count int32, kind uint32, indices unsafe.Pointer) {
	...
	ccount, _ := (C.GLsizei)(count), cgoAllocsUnknown
	ckind, _ := (C.GLenum)(kind), cgoAllocsUnknown
	cindices, _ := (C.GLvoid)(unsafe.Pointer(indices)), cgoAllocsUnknown
...
func GetPointerv(pname uint32, params []unsafe.Pointer) {
	cpname, _ := (C.GLenum)(pname), cgoAllocsUnknown
	cparams, _ := (*C.GLvoid)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&params)).Data)), cgoAllocsUnknown
...
func ReadPixels(x int32, y int32, width int32, height int32, format uint32, kind uint32, pixels unsafe.Pointer) {
	...
	cformat, _ := (C.GLenum)(format), cgoAllocsUnknown
	ckind, _ := (C.GLenum)(kind), cgoAllocsUnknown
	cpixels, _ := (C.GLvoid)(unsafe.Pointer(pixels)), cgoAllocsUnknown
