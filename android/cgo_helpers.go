...
// WARNING: This file has automatically been generated on Sat, 28 May 2016 05:14:21 MSK.
...
func NewSensorVectorRef(ref interface{}) *SensorVector {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	obj.refdc35e822 = (*C.ASensorVector)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func NewMetaDataEventRef(ref interface{}) *MetaDataEvent {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	obj.ref4f7ec3e5 = (*C.AMetaDataEvent)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func NewHeartRateEventRef(ref interface{}) *HeartRateEvent {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	obj.ref1342bcf5 = (*C.AHeartRateEvent)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func NewSensorEventRef(ref interface{}) *SensorEvent {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(SensorEvent)
	obj.refb7a6c7dc = (*C.ASensorEvent)(unsafe.Pointer(hdr.Ref))
	return obj
}
