...
// SetActiveTexture function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glActiveTexture.xhtml
...
// SetBlendColor function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glBlendColor.xhtml
func SetBlendColor(red float32, green float32, blue float32, alpha float32) {
...
// SetBlendEquation function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glBlendEquation.xhtml
func SetBlendEquation(mode uint32) {
...
// SetCullFace function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glCullFace.xhtml
...
// SetDepthFunc function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glDepthFunc.xhtml
...
// SetFrontFace function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glFrontFace.xhtml
...
// SetLineWidth function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glLineWidth.xhtml
...
// SetSampleCoverage function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glSampleCoverage.xhtml
...
// SetStencilFunc function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glStencilFunc.xhtml
...
// SetViewport function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glViewport.xhtml
...
// SetReadBuffer function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glReadBuffer.xhtml
func SetReadBuffer(mode uint32) {
	cmode, _ := (C.GLenum)(mode), cgoAllocsUnknown
...
func GetQueryObjectuiv(id uint32, pname uint32, params []uint32) {
	cid, _ := (C.GLuint)(id), cgoAllocsUnknown
	cpname, _ := (C.GLenum)(pname), cgoAllocsUnknown
	cparams, _ := (*C.GLuint)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&params)).Data)), cgoAllocsUnknown
...
// GetIntegeriV function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glGetIntegeri_v.xhtml
func GetIntegeriV(target uint32, index uint32, data []int32) {
	ctarget, _ := (C.GLenum)(target), cgoAllocsUnknown
	cindex, _ := (C.GLuint)(index), cgoAllocsUnknown
	cdata, _ := (*C.GLint)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&data)).Data)), cgoAllocsUnknown
...
// SetTransformFeedbackVaryings function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glTransformFeedbackVaryings.xhtml
func SetTransformFeedbackVaryings(program uint32, count int32, varyings []string, bufferMode uint32) {
	cprogram, _ := (C.GLuint)(program), cgoAllocsUnknown
	ccount, _ := (C.GLsizei)(count), cgoAllocsUnknown
...
func Uniform1uiv(location int32, count int32, value []uint32) {
	clocation, _ := (C.GLint)(location), cgoAllocsUnknown
	ccount, _ := (C.GLsizei)(count), cgoAllocsUnknown
	cvalue, _ := (*C.GLuint)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&value)).Data)), cgoAllocsUnknown
...
// SetUniformBlockBinding function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glUniformBlockBinding.xhtml
func SetUniformBlockBinding(program uint32, uniformBlockIndex uint32, uniformBlockBinding uint32) {
	cprogram, _ := (C.GLuint)(program), cgoAllocsUnknown
	cuniformBlockIndex, _ := (C.GLuint)(uniformBlockIndex), cgoAllocsUnknown
...
// GetInteger64iV function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glGetInteger64i_v.xhtml
func GetInteger64iV(target uint32, index uint32, data []int64) {
	ctarget, _ := (C.GLenum)(target), cgoAllocsUnknown
	cindex, _ := (C.GLuint)(index), cgoAllocsUnknown
	cdata, _ := (*C.GLint64)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&data)).Data)), cgoAllocsUnknown
...
func SamplerParameteriv(sampler uint32, pname uint32, param []int32) {
	csampler, _ := (C.GLuint)(sampler), cgoAllocsUnknown
	cpname, _ := (C.GLenum)(pname), cgoAllocsUnknown
	cparam, _ := (*C.GLint)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&param)).Data)), cgoAllocsUnknown
...
func SamplerParameterfv(sampler uint32, pname uint32, param []float32) {
	csampler, _ := (C.GLuint)(sampler), cgoAllocsUnknown
	cpname, _ := (C.GLenum)(pname), cgoAllocsUnknown
	cparam, _ := (*C.GLfloat)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&param)).Data)), cgoAllocsUnknown
...
func DispatchCompute(numGroupsX uint32, numGroupsY uint32, numGroupsZ uint32) {
	cnumGroupsX, _ := (C.GLuint)(numGroupsX), cgoAllocsUnknown
	cnumGroupsY, _ := (C.GLuint)(numGroupsY), cgoAllocsUnknown
	cnumGroupsZ, _ := (C.GLuint)(numGroupsZ), cgoAllocsUnknown
...
func DispatchComputeIndirect(indirect int) {
	cindirect, _ := (C.GLintptr)(indirect), cgoAllocsUnknown
...
func DrawArraysIndirect(mode uint32, indirect unsafe.Pointer) {
	cmode, _ := (C.GLenum)(mode), cgoAllocsUnknown
	cindirect, _ := (unsafe.Pointer)(unsafe.Pointer(indirect)), cgoAllocsUnknown
...
func GetProgramInterfaceiv(program uint32, programInterface uint32, pname uint32, params []int32) {
	cprogram, _ := (C.GLuint)(program), cgoAllocsUnknown
	cprogramInterface, _ := (C.GLenum)(programInterface), cgoAllocsUnknown
	cpname, _ := (C.GLenum)(pname), cgoAllocsUnknown
	cparams, _ := (*C.GLint)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&params)).Data)), cgoAllocsUnknown
...
func GetProgramResourceiv(program uint32, programInterface uint32, index uint32, propCount int32, props []uint32, bufSize int32, length []int32, params []int32) {
	...
	cprogramInterface, _ := (C.GLenum)(programInterface), cgoAllocsUnknown
	cindex, _ := (C.GLuint)(index), cgoAllocsUnknown
	cpropCount, _ := (C.GLsizei)(propCount), cgoAllocsUnknown
	cprops, _ := (*C.GLenum)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&props)).Data)), cgoAllocsUnknown
	cbufSize, _ := (C.GLsizei)(bufSize), cgoAllocsUnknown
	clength, _ := (*C.GLsizei)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&length)).Data)), cgoAllocsUnknown
	cparams, _ := (*C.GLint)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&params)).Data)), cgoAllocsUnknown
...
func UseProgramStages(pipeline uint32, stages uint32, program uint32) {
	cpipeline, _ := (C.GLuint)(pipeline), cgoAllocsUnknown
	cstages, _ := (C.GLbitfield)(stages), cgoAllocsUnknown
	cprogram, _ := (C.GLuint)(program), cgoAllocsUnknown
...
func DeleteProgramPipelines(n int32, pipelines []uint32) {
	cn, _ := (C.GLsizei)(n), cgoAllocsUnknown
	cpipelines, _ := (*C.GLuint)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pipelines)).Data)), cgoAllocsUnknown
...
func BindImageTexture(unit uint32, texture uint32, level int32, layered byte, layer int32, access uint32, format uint32) {
	...
	ctexture, _ := (C.GLuint)(texture), cgoAllocsUnknown
	clevel, _ := (C.GLint)(level), cgoAllocsUnknown
	clayered, _ := (C.GLboolean)(layered), cgoAllocsUnknown
	clayer, _ := (C.GLint)(layer), cgoAllocsUnknown
	caccess, _ := (C.GLenum)(access), cgoAllocsUnknown
	cformat, _ := (C.GLenum)(format), cgoAllocsUnknown
	C.glBindImageTexture(cunit, ctexture, clevel, clayered, clayer, caccess, cformat)
}

// GetBooleaniV function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glGetBooleani_v.xhtml
func GetBooleaniV(target uint32, index uint32, data []byte) {
	ctarget, _ := (C.GLenum)(target), cgoAllocsUnknown
	cindex, _ := (C.GLuint)(index), cgoAllocsUnknown
	cdata, _ := (*C.GLboolean)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&data)).Data)), cgoAllocsUnknown
...
func MemoryBarrier(barriers uint32) {
	cbarriers, _ := (C.GLbitfield)(barriers), cgoAllocsUnknown
...
func TexStorage2DMultisample(target uint32, samples int32, internalformat uint32, width int32, height int32, fixedsamplelocations byte) {
	...
	cwidth, _ := (C.GLsizei)(width), cgoAllocsUnknown
	cheight, _ := (C.GLsizei)(height), cgoAllocsUnknown
	cfixedsamplelocations, _ := (C.GLboolean)(fixedsamplelocations), cgoAllocsUnknown
...
func GetMultisamplefv(pname uint32, index uint32, val []float32) {
	cpname, _ := (C.GLenum)(pname), cgoAllocsUnknown
	cindex, _ := (C.GLuint)(index), cgoAllocsUnknown
	cval, _ := (*C.GLfloat)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&val)).Data)), cgoAllocsUnknown
...
func SampleMaski(maskNumber uint32, mask uint32) {
	cmaskNumber, _ := (C.GLuint)(maskNumber), cgoAllocsUnknown
	cmask, _ := (C.GLbitfield)(mask), cgoAllocsUnknown
...
func BindVertexBuffer(bindingindex uint32, buffer uint32, offset int, stride int32) {
	cbindingindex, _ := (C.GLuint)(bindingindex), cgoAllocsUnknown
	cbuffer, _ := (C.GLuint)(buffer), cgoAllocsUnknown
	coffset, _ := (C.GLintptr)(offset), cgoAllocsUnknown
	cstride, _ := (C.GLsizei)(stride), cgoAllocsUnknown
...
func VertexAttribFormat(attribindex uint32, size int32, kind uint32, normalized byte, relativeoffset uint32) {
	cattribindex, _ := (C.GLuint)(attribindex), cgoAllocsUnknown
	csize, _ := (C.GLint)(size), cgoAllocsUnknown
	ckind, _ := (C.GLenum)(kind), cgoAllocsUnknown
	cnormalized, _ := (C.GLboolean)(normalized), cgoAllocsUnknown
	crelativeoffset, _ := (C.GLuint)(relativeoffset), cgoAllocsUnknown
...
// SetVertexAttribBinding function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glVertexAttribBinding.xhtml
func SetVertexAttribBinding(attribindex uint32, bindingindex uint32) {
	cattribindex, _ := (C.GLuint)(attribindex), cgoAllocsUnknown
	cbindingindex, _ := (C.GLuint)(bindingindex), cgoAllocsUnknown
	C.glVertexAttribBinding(cattribindex, cbindingindex)
}

// SetVertexBindingDivisor function as declared in https://www.khronos.org/opengles/sdk/docs/man31/html/glVertexBindingDivisor.xhtml
func SetVertexBindingDivisor(bindingindex uint32, divisor uint32) {
	cbindingindex, _ := (C.GLuint)(bindingindex), cgoAllocsUnknown
	cdivisor, _ := (C.GLuint)(divisor), cgoAllocsUnknown
