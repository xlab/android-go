...
// WARNING: This file has automatically been generated on Sat, 28 May 2016 05:14:19 MSK.
...
func ShaderSource(shader Uint, count Sizei, _string []string, length []Int) {
	cshader, _ := (C.GLuint)(shader), cgoAllocsUnknown
	ccount, _ := (C.GLsizei)(count), cgoAllocsUnknown
	c_string, _ := unpackArgSString(_string)
